...
########################################
host = "dadp-project3-postgres.postgres.database.azure.com"  #### replace with your actual postgresql servername
user = "gursevak"
password = ""

# Create a new DB
sslmode = "require"
dbname = "postgres"    ###new database will be created with this name
